...
public class InterpolatingTable 
{
    ...
    private static final TreeMap<Double, ShotParameter> map = new TreeMap<>(
        Map.ofEntries(
            ...
            entry(1.72, new ShotParameter(29, .4, 0.0)),
            entry(2.08, new ShotParameter(30, .4, 0.0)),
            entry(2.5, new ShotParameter(31, .4, 0.0)), 
            entry(3.2, new ShotParameter(38, .47, 0.0)),
            entry(4.11, new ShotParameter(40, .5, 0.0)),
            entry(5.0, new ShotParameter(44, .6, 0.0))
        )
